---
title: 'mitology Workflow: scRNAseq and ST'
output:
    github_document:
        toc: false
        toc_depth: 2
...
Further details on how to use `mitology` are available in the [vignette](https://bioconductor.org/packages/release/bioc/vignettes/mitology/inst/doc/mitology.html), that includes examples and documentation.
